	...
	<div class="product_grid_display group">
		<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
			<div class="product_grid_item product_view_<?php echo wpsc_the_product_id(); ?>">
				...
				<?php if(wpsc_product_on_special()) : ?><span class="sale"><?php _e('Solde', 'wpsc'); ?></span><?php endif; ?>
				<?php if(get_option('show_images_only') != 1): ?>
						...
						<?php endif; ?>
                        	<div class="price_container">
								...
								<?php if(wpsc_show_pnp()) : ?>
									<p class="pricedisplay"><?php _e('Livraison', 'wpsc'); ?>:<span class="pp_price"><?php echo wpsc_product_postage_and_packaging(); ?></span></p>
								<?php endif; ?>
					...
					<div class="grid_more_info">
						<form class="product_form"  enctype="multipart/form-data" action="<?php echo wpsc_this_page_url(); ?>" method="post" name="product_<?php echo wpsc_the_product_id(); ?>" id="product_<?php echo wpsc_the_product_id(); ?>" >
                         ...
                         <fieldset><legend><?php _e('Options de produits', 'wpsc'); ?></legend>
						<div class="wpsc_variation_forms">
							...
							<?php endwhile; ?>
   							...
   							<div id="variation_display_<?php echo wpsc_the_product_id(); ?>" class="is_variation"><?php _e('Les variantes de produits ne sont pas disponibles', 'wpsc'); ?></div>
							...
							<?php if((get_option('display_addtocart') == 1) && (get_option('addtocart_or_buynow') !='1')) :?>
								<?php if(wpsc_product_has_stock()) : ?>
		                            ...
		                            <div class="quantity_container">
										<label class="wpsc_quantity_update" for="wpsc_quantity_update_<?php echo wpsc_the_product_id(); ?>"><?php _e('Quantite:', 'wpsc'); ?></label>
								...
								<?php else : ?>
									<p class="soldout"><?php _e('Desole, article indisponible!', 'wpsc'); ?></p>
								<?php endif ; ?>
							<?php endif; ?>
										...
										<div class="wpsc_loading_animation">
											...
											<?php _e('Mise a jour du panier...', 'wpsc'); ?>
		...
		<?php if(wpsc_product_count() == 0):?>
			<p><?php  _e('Pas de produits dans ce groupe.', 'wpsc'); ?></p>
		<?php endif ; ?>
